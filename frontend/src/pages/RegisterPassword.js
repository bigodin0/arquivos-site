...
const RegisterPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Armazenar dados para uso posterior - use localStorage para dados de registro
      // pois precisamos que esses dados persistam entre páginas durante o processo de registro
      // Observe que esses dados serão removidos após o registro completo
